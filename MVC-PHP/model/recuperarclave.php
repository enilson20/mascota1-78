...
if ($_POST['cont']== "" || $_POST['conta']== "" )
	...
	else
	{
        ...
        $doc = $_SESSION['ced'];
        $insertSQL = "UPDATE usuario SET password ='$contra'  WHERE identificacion = '$doc'";
...
if($_POST["inicio"])
{
	...
	$doc = $_POST["doc"];
    $correo = $_POST["correo"];
	$sql="select * from usuario where identificacion = '$doc'and correo = '$correo' "; 	
        ...
        <html>
            ...
            <body>
                <div class="login-box">
                    ...
                    <img src="../../img/logogato.png" class="avatar" alt="Avatar Image">
                        ...
                        <form  method="post"  name="form1" id="form1" autocomplete="off" >
                            ...
                            <a href="../index.html">Volver Pagina Principal</a>
                             <!--TAREA VALIDA QUE LAS DOS CONTRASEÑAS SEAN IGUALES Y QUE SEA FUERTE-->
                        </form>
            </body>
        </html>
    <?php
