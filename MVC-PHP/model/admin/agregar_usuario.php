...
<head>
    ...
    <body onload = "frmadd.tip_usu.focus()">
        <section class="title">
            <h1>Formulario Creacion Tipos de Usuarios   <?php echo $usua['tipo_usuario']?></h1>
        </section>
        ...
        <table class ="centrar" border = "1">
            <form method= "POST" name="frmadd" autocplete = "off">
                ...
                <tr>
                    <td>Tipo Usuario</td>
                    <td><input type= "text" name="tip_usu"placeholder="ingrese tipo de usuario" style="text-transform:uppercase"> </td>
                </tr>
