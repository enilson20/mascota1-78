    ...
    <body onload = "frmadd.tip_est.focus()">
        ...
        <table class ="centrar" border = "1">
            <form method= "POST" name="frmadd" autocplete = "off">
                ...
                <tr>
                    <td colspan="2"> tipos de estados </td>
                </tr>
                ...
                <tr>
                    <td>Tipo de Estados</td>
                    <td><input type= "text" name="tip_est"placeholder="ingrese tipo de estado" style="text-transform:uppercase"> </td>
                </tr>
